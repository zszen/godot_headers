...
var editor:Curve_Editor = null

var handles := []
var buttons := []
var handle_mode:int
var handle_index:int
var handle_pos

const curve_editor_script = preload("curve_editor.gd")
const rope_script = preload("rope.gd")
#const test_script = preload("test_button.gd")

const handle_tex = preload("handle.png")
const add_tex = preload("add.png")
const remove_tex = preload("remove.png")
const pin_tex = preload("pin.jpg")
...
#func _ready():
#	rope_script = load("res://addons/Rope/rope.gd")
...
#    var godot_version = OS.get_engine_version()
    is_godot21 = false #godot_version.major == "2" && godot_version.minor == "1"
    add_custom_type("Rope", "Node2D", preload("rope.gd"), preload("icon.png"))
#    add_custom_type("Rope", "Node2D", rope_script, Icon)
#    add_custom_type("Rope", "Node", test_script, Icon)
